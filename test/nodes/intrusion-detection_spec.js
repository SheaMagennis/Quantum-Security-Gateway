...
let baseJSON= `{payload: {%s,`+
      ...
      '\'dbytes\': {\'0\': 0, \'1\': 0}, \'rate\': {\'0\': 90909.0902, \'1\': 125000.0003}, \'sttl\': ' +
      '{\'0\': 254, \'1\': 254}, \'dttl\': {\'0\': 0, \'1\': 0}, \'sload\': {\'0\': 180363632, \'1\': 881000000},' +
      ' \'dload\': {\'0\': 0, \'1\': 0}, \'sloss\': {\'0\': 0, \'1\': 0}, \'dloss\': {\'0\': 0, \'1\': 0},' +
      ' \'sinpkt\': {\'0\': 0.011, \'1\': 0.008}, \'dinpkt\': {\'0\': 0, \'1\': 0}, \'sjit\': {\'0\': 0, \'1\': 0},' +
      ' \'djit\': {\'0\': 0, \'1\': 0}, \'swin\': {\'0\': 0, \'1\': 0}, \'stcpb\': {\'0\': 0, \'1\': 0}, \'dtcpb\': ' +
      '{\'0\': 0, \'1\': 0}, \'dwin\': {\'0\': 0, \'1\': 0}, \'tcprtt\': {\'0\': 0, \'1\': 0},'+
      '\'synack\': {\'0\': 0, \'1\': 0}, \'ackdat\': {\'0\': 0, \'1\': 0}, \'smean\': {\'0\': 248, \'1\': 881},' +
      ' \'dmean\': {\'0\': 0, \'1\': 0}, \'trans_depth\': {\'0\': 0, \'1\': 0}, \'response_body_len\': ' +
      '{\'0\': 0, \'1\': 0}, \'ct_srv_src\': {\'0\': 2, \'1\': 2}, \'ct_state_ttl\': {\'0\': 2, \'1\': 2},' +
      ' \'ct_dst_ltm\': {\'0\': 1, \'1\': 1}, \'ct_src_dport_ltm\': {\'0\': 1, \'1\': 1},'+
      '\'ct_dst_sport_ltm\': {\'0\': 1, \'1\': 1}, \'ct_dst_src_ltm\': {\'0\': 2, \'1\': 2}, \'is_ftp_login\': ' +
      '{\'0\': 0, \'1\': 0}, \'ct_ftp_cmd\': {\'0\': 0, \'1\': 0}, \'ct_flw_http_mthd\': {\'0\': 0, \'1\': 0}, ' +
      '\'ct_src_ltm\': {\'0\': 1, \'1\': 1}, \'ct_srv_dst\': {\'0\': 2, \'1\': 2}, \'is_sm_ips_ports\':' +
      ' {\'0\': 0, \'1\': 0}}}';
...
describe('IntrusionDetectionNode', function() {
  ...
  it('return error if values are wrong type', function(done) {
    ...
    console.log(JSON.stringify(givenInput));
